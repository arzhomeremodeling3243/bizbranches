...
export function generateMetadata(): Metadata {
  ...
  const url = "https://www.pakbizbranhces.online/dermaluxe-clinic-by-dr-rabia-ishfaq-lahore-1/"
...
export default function Page() {
  return <CatchAllPageClient slug="dermaluxe-clinic-by-dr-rabia-ishfaq-lahore-1" />
}
