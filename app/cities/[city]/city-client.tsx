...
export default function CityClient({ citySlug }: { citySlug: string }) {
    ...
    return (
      <>
        ...
        <main className="bg-[#f8fafc] min-h-screen py-16 text-center">
          <h2 className="text-2xl font-bold text-red-600">City Not Found</h2>
          <p className="text-slate-500 mt-2">The requested city does not exist.</p>
        </main>
        <Footer />
      </>
    )
      ...
      <>
        ...
        <main className="bg-[#f8fafc] min-h-screen py-16 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-slate-500 font-medium text-sm animate-pulse">Loading businesses in {cityName}...</p>
          </div>
        </main>
        <Footer />
      </>
  ...
  const pageUrl = `${BASE_URL}/cities/${citySlug}`
